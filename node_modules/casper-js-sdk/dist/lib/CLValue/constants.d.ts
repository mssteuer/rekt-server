...
export declare const BOOL_TYPE = "Bool";
export declare const KEY_TYPE = "Key";
export declare const PUBLIC_KEY_TYPE = "PublicKey";
export declare const STRING_TYPE = "String";
export declare const UREF_TYPE = "URef";
export declare const UNIT_TYPE = "Unit";
export declare const I32_TYPE = "I32";
export declare const I64_TYPE = "I64";
export declare const U8_TYPE = "U8";
export declare const U32_TYPE = "U32";
export declare const U64_TYPE = "U64";
export declare const U128_TYPE = "U128";
export declare const U256_TYPE = "U256";
export declare const U512_TYPE = "U512";
export declare const BYTE_ARRAY_TYPE = "ByteArray";
export declare const LIST_TYPE = "List";
export declare const MAP_TYPE = "Map";
export declare const OPTION_TYPE = "Option";
export declare const RESULT_TYPE = "Result";
export declare const TUPLE1_TYPE = "Tuple1";
export declare const TUPLE2_TYPE = "Tuple2";
export declare const TUPLE3_TYPE = "Tuple3";
export declare const ANY_TYPE = "Any";
export declare const ACCOUNT_HASH_TYPE = "AccountHash";
