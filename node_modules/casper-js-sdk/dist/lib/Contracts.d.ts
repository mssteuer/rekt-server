...
export declare class Contract {
     ...
     */
    queryContractData(path?: string[], casperClient?: CasperClient, stateRootHash?: string): Promise<any>;
    /**
 ...
 */
export declare const toCLMap: (map: Map<string, string>) => import("./CLValue/Map").CLMap<CLValue, CLValue>;
/**
